    ...
    <Router>
      <div className={`App ${isDarkMode ? 'dark' : 'light'}`}>
        ...
        <footer>
          ...
          <p>
            <strong>Disclaimer:</strong> This app is not a substitute for professional mental health care. For immediate help, call the National Suicide Lifeline at 988.
          </p>
        </footer>

        {isChatOpen && <ChatbotPopup onClose={toggleChat} isDarkMode={isDarkMode} />}
      </div>
    </Router>
  );
}
